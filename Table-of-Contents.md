...
## 📁 01-Planning
![Planning](../01-Planning/Planning%20&%20Lab%20Overview.md)  
...
- [Windows-Client-Setup.md](../02-Environment-Setup/Windows-Client-Setup.md)  
  *Setup and domain joining of Windows 10 client machines.*
---
...
- [DHCP-Configuration.md](../03-Configuration/DHCP-Configuration.md)  
  *DHCP server installation, scope creation, and configuration for dynamic host management.*
- [Active-Directory-Certificate-Services.md](../03-Configuration/Active-Directory-Certificate-Services.md)  
  *Enterprise Certificate Authority deployment and configuration for secure network communications.*
- [Windows-Deployment-Services.md](../03-Configuration/Windows-Deployment-Services.md)  
  *Windows Deployment Services installation and configuration for automated operating system deployment.*
...
- [User-Rights-Assignment.md](../04-Security-Policies/User-Rights-Assignment.md)  
  *User Rights Assignment configuration for security policy and privilege management.*
- [Windows-Defender-Policies.md](../04-Security-Policies/Windows-Defender-Policies.md)  
  *Windows Defender policy configuration for endpoint protection and malware prevention.*
- [Local-Administrator-Restrictions.md](../04-Security-Policies/Local-Administrator-Restrictions.md)  
  *Local Administrator Restrictions configuration for privileged access control and endpoint security.*
